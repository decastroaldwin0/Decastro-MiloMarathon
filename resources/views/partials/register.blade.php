    ...
    <form action="{{ route('partials.store') }}" method="POST">
        ...
        <div>
            ...
            <select name="marathon_category" required>
                ...
                <option value="3K" {{ old('marathon_category') == '3K' ? 'selected' : '' }}>3K</option>
                <option value="5K" {{ old('marathon_category') == '5K' ? 'selected' : '' }}>5K</option>
                <option value="10K" {{ old('marathon_category') == '10K' ? 'selected' : '' }}>10K</option>
                <option value="21K" {{ old('marathon_category') == '21K' ? 'selected' : '' }}>21K</option>
            </select>
        </div>
        ...
        <div class="full btn-group">
            ...
            <button type="submit" class="btn">Register Runner</button>
        </div>
